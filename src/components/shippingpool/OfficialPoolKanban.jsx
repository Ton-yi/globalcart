...
import { Package, GripVertical, Users, Loader2, Scale, ChevronRight } from "lucide-react";
  ...
  if (pools.length === 0) {
    return (
      <div className="flex flex-col items-center py-20 text-gray-400">
        ...
        <p className="text-sm">暂无官方拼邮看板</p>
        <p className="text-xs mt-1">管理员可在"新增发货申请"中创建拼邮请求</p>
      </div>
    );
  }
    ...
    <div className="relative">
      ...
      <div className="flex gap-4 overflow-x-auto pb-4" style={{ minHeight: 400 }}>
        {pools.map(pool => {
          ...
          const isDragTarget = dragOverPoolId === pool.id && draggingFromPoolId !== pool.id;
          const totalWeight = poolOrders.reduce((s, o) => s + (o.weight_g || 0), 0);

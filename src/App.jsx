...
import AdminTransitWorkPanel from '@/pages/AdminTransitWorkPanel';
...
const AuthenticatedApp = () => {
  ...
  return (
    <Routes>
      ...
      <Route path="/AdminTransitWorkPanel" element={
        <LayoutWrapper currentPageName="AdminTransitWorkPanel">
          <AdminTransitWorkPanel />
        </LayoutWrapper>
      } />
